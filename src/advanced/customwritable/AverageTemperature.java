...
public class AverageTemperature {
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        // arquivo de entrada
        Path input = new Path("in/forestfireinputA.csv");

        // arquivo de saida
        Path output = new Path("output/teste");
    ...
    /**
     * 1a Parametro: tipo da chave de entrada
     * 2a Parametro: tipo do valor de entrada
     * -----------------------------------------
     * 3a Parametro: tipo da chave de saida
     * 4a Parametro: tipo de valor de saida
     */
    public static class MapForAverage extends Mapper<LongWritable, Text, Text, FireAvgTempWritable> {
        ...
        public void map(LongWritable key, Text value, Context con)
            ...
            //funcao de map eh exeutada por bloco, e na realidade eh executada por LINHA
            ...
            con.write(new Text(colunas[2]), new FireAvgTempWritable(1, temperatura));
            // COMENTARIO IMPORTANTE!!!
            // usando sempre a mesma chave para garantir que todos os resultados
            // originais de maps diferentes cheguem no mesmo reduce

        }
    }
    // Recebe como entrada <chave, lista de valores>
    // Chave = "auxiliar"
    // Lista de valores = Lista de contempla diferentes FireAvgTempWritables (m,soma)
    // Objetivo do reduce
    ...
    public static class ReduceForAverage extends Reducer<Text, FireAvgTempWritable, Text, FloatWritable> {
        ...
        public void reduce(Text word, Iterable<FireAvgTempWritable> values, Context con)
            ...
            con.write(new Text(word), new FloatWritable(media));
    ...
    public static class CombinerForAverage extends Reducer<Text, FireAvgTempWritable, Text, FireAvgTempWritable> {
        ...
        public void reduce(Text key, Iterable<FireAvgTempWritable> valores, Context con) throws IOException, InterruptedException{
